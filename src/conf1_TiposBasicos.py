...
# print(str(100)+"99") #se puede convertir un entero a string con str. La operacion + sobre string concatena los dos string
...
# print(f'Estas tecleando a una velocidad de {duracion/len(nombre):.4f} caracteres x seg.')
#endregion
...
#Teclee los coeficientes de un polinomio a_x**2+b_x+c y calcule el valor del polinomio para un cierto valor de x
